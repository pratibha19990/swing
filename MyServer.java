...
if(s!=null)
{
JOptionPane.showMessageDialog(chatWindow,"You are logged in right now :) ","Exit",JOptionPane.INFORMATION_MESSAGE);
logoutSession();
}
System.exit(0);
}
...
{
if(s==null)
 	{JOptionPane.showMessageDialog(chatWindow,"You have not logged in, Please login first!"); return;}
try{
...
if(temp==loginButton)
{
String uname=JOptionPane.showInputDialog(chatWindow,"Enter Your Sweet Name: ");
if(uname!=null)
	clientChat(uname); 
}
...
if(s!=null)
{
JOptionPane.showMessageDialog(chatWindow,"Oops! You are logged out. ","Exit",JOptionPane.INFORMATION_MESSAGE);
logoutSession();
}
System.exit(0);
}
